...
class DRQAgent(object):
    ...
    def __init__(self, args, obs_shape, action_shape, action_range, device, discount,
                 init_temperature, lr, actor_update_frequency, critic_tau,
                 critic_target_update_frequency, batch_size, hidden_dim, hidden_depth, log_std_min, log_std_max, encoder_cfg):
        ...
        self.actor = Actor(encoder_cfg, action_shape, hidden_dim, hidden_depth, log_std_min, log_std_max).to(self.device)

        self.critic = Critic(encoder_cfg, action_shape, hidden_dim, hidden_depth).to(self.device)
        self.critic_target = Critic(encoder_cfg, action_shape, hidden_dim, hidden_depth).to(
            self.device)
